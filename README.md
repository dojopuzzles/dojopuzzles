[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/berrondo/dojopuzzles/blob/django-version-upgrade)
...
[`isort`](https://github.com/PyCQA/isort). [`pre-commit`](https://pre-commit.com/)
hooks are available so make sure to install and ensure they are executed then before
submitting any code to the project.
